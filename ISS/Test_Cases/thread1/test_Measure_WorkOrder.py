...
class test_Measure_WorkOrder(unittest.TestCase):
    ...
    def webwait(self):
        ...
        try:
            ...
            WebDriverWait(self.driver,5).until_not(lambda x:x.find_element_by_css_selector("#saleOrdMeasureHdAccordiondiv.panel-body.accordion-body > div > div > div.datagrid-mask-msg"))
