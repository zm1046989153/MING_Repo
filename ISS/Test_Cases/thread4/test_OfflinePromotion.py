...
if __name__=='__main__':
    ...
    #suite.addTest(test_OfflinePromotion('test_8delete_Promotion'))#删除促销
    suite.addTest(test_OfflinePromotion('test_9modify_ApprovalStatus'))#修改审批状态
